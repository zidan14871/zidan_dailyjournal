...
if (isset($_POST['simpan'])) {
    $username = $_POST['username']; // Username diambil dari input form
    $password = md5($_POST['password']);   // Password diambil dari input form
    $foto = 'foto'; // Inisialisasi variabel foto
